...
public final class TLAConstants {
	...
	// Depends on .env file in the root directory
	public static Boolean RELIABLE_NETWORK = true;
	...
	public static final String MODULE_OPENING_PREFIX_REGEX = "^([-]+ " + KeyWords.MODULE + ") ";
