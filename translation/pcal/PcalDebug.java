...
public class PcalDebug
{
    ...
    public static void reportSuccess(String successText) {
        ToolIO.out.println( " ✅ " + successText);
    }

    public static void reportWrite(String writeText) {
         ToolIO.out.println(writeText);
    }
