...
public class PcalCharReader {
    ...
    public PcalCharReader copy() {
        PcalCharReader copy = new PcalCharReader(this.vec, this.line, this.column, this.lastLine, this.lastColumn);
        copy.currentLine = this.currentLine;
        copy.vcolumn = this.vcolumn;
        copy.tabToSpaces = this.tabToSpaces;
        return copy;
    }
    ...
    public PcalCharReader(Vector vector, int firstLine, int firstCol, int lastLine, int lastCol, boolean keepSpecials) {
        this.vec = vector;
        this.line = firstLine;
     ...
     *********************************************************************/
    {
        ...
        for (int i = 0; i < this.vec.size(); i++) {
            String text = (String) this.vec.get(i);
            text = text.replace("<|", "<<");
            text = text.replace("|>", ">>");
            this.vec.set(i, text);
        }
