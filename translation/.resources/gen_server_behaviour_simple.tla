...
EXTENDS Naturals, Sequences, TLC, FiniteSets, Typecheck, Timeouts, GenServerUtil, ShiVizExt, Encoder
...
\* BEGIN TRANSLATION
\* Process variable timeout of process genServer at line 705 col 25 changed to timeout_
\* Process variable module of process genServer at line 716 col 25 changed to module_
\* Process variable mRef of process genServer at line 719 col 29 changed to mRef_
\* Process variable mRefRes of process genServer at line 720 col 29 changed to mRefRes_
\* Process variable z of process genServer at line 722 col 29 changed to z_
\* Process variable z of process workerClient at line 898 col 25 changed to z_w
\* Process variable module of process workerClient at line 899 col 25 changed to module_w
\* Process variable monitorSuccess of process workerClient at line 900 col 25 changed to monitorSuccess_
\* Process variable mRef of process workerClient at line 901 col 25 changed to mRef_w
\* Process variable mRefRes of process workerClient at line 902 col 25 changed to mRefRes_w
...
C_WAIT_ACK_genStart6_genStart6(self) == /\ pc[self] = "C_WAIT_ACK_genStart6_genStart6"
                                        ...
                                        /\ IF Len(results[self]) > 0
                                              THEN /\ rVal' = [rVal EXCEPT ![self] = Head(results[self])]
                                                   ...
                                                   /\ Assert(rVal'[self].result = "ack", 
                                                             "Failure of assertion at line 275, column 9 of macro called at line 963, column 25.")
                                                   /\ calls' = calls
...
W_STOP(self) == /\ pc[self] = "W_STOP"
                /\ Assert(~rVal[self](.)<<"result", "error">> \/ ~rVal[self](.)<<"reason", "bad_arg">>, 
                          "Failure of assertion at line 967, column 25.")
